...
function rc_register_plugin_styles() {
	...
	wp_register_style( 'rcp-forms', trailingslashit( plugins_url() ) . 'restrict-content/includes/assets/css/rc-forms.css', array(), '20170828' );
	wp_register_script( 'rcp-register', trailingslashit( plugins_url() ) . 'restrict-content/includes/assets/js/rc-register.js', array( 'jquery' ), '20170828' );
